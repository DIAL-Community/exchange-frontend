...
import DatasetDetailCountries from '../../../components/datasets/DatasetDetailCountries'
...
import { countries, dataset } from './data/DatasetDetailCountries'

mockNextUseRouter()
describe('Unit test for the DatasetDetailCountries component.', () => {
  const EDIT_BUTTON_TEST_ID = 'edit-button'
  const CANCEL_BUTTON_TEST_ID = 'cancel-button'
  const COUNTRY_SEARCH_TEST_ID = 'country-search'
  const COUNTRY_SEARCH_OPTION_LABEL = 'Another Country'
  const DATASET_TEST_COUNTRY_LABEL = 'Test Country'
  ...
  test('Should add a pill and revert changes on "Cancel" button click', async () => {
    ...
    expect(screen.queryByText(DATASET_TEST_COUNTRY_LABEL)).toBeInTheDocument()
