...
const OrganizationDetailNav = ({ scrollRef }) => {
  ...
  const navOptions = [{
    ...
    label: format('ui.organization.pricing.title'),
    value: 'ui.organization.pricing.title'
  }, {
...
export default OrganizationDetailNav
