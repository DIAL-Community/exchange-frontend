...
const CityDetailNav = ({ scrollRef }) => {
  ...
  const navOptions = [{
    ...
    label: format('ui.city.pricing.title'),
    value: 'ui.city.pricing.title'
  }, {
    ...
    label: format('ui.city.header'),
    value: 'ui.city.header'
  }, {
