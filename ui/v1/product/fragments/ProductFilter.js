...
const ProductFilter = () => {
  ...
  const { sdgs, showBeta, govStackOnly } = useContext(ProductFilterContext)
  const { setSDGs, setShowBeta, setShowGovStack } = useContext(ProductFilterDispatchContext)
          ...
          <div className='flex flex-row flex-wrap gap-1 text-sm'>
              ...
              <div className='bg-dial-slate-400 px-2 py-1 rounded'>
                <div className='flex flex-row gap-1'>
                  <div className='flex gap-x-1'>
                    {format('ui.product.filter.showDraft')}
            ...
            {govStackOnly && (
              <div className='bg-dial-slate-400 px-2 py-1 rounded'>
                <div className='flex flex-row gap-1'>
                  <div className='flex gap-x-1'>
                    {format('ui.product.filter.govStackOnly')}
