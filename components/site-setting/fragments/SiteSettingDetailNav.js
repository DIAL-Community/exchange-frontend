...
const SiteSettingDetailNav = ({ scrollRef }) => {
  ...
  const navOptions = [{
    ...
    label: format('ui.siteSetting.carousel.header'),
    value: 'ui.siteSetting.carousel.header'
  }, {
    label: format('ui.siteSetting.heroCard.header'),
    value: 'ui.siteSetting.heroCard.header'
  }, {
    label: format('ui.siteSetting.menu.header'),
    value: 'ui.siteSetting.menu.header'
  }]
...
export default SiteSettingDetailNav
