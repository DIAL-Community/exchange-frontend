...
const StorefrontDetailSectors = ({ organization, editingAllowed }) => {
  ...
  const [updateStorefrontSectors, { loading, reset }] = useMutation(UPDATE_ORGANIZATION_SECTORS, {
    onError() {
      setIsDirty(false)
...
export default StorefrontDetailSectors
