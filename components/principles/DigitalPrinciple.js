...
const DigitalPrinciple = ({ principle }) => {
  return (
    <a className='max-w-sm bg-white border-4 border-dial-gray p-4 m-4 shadow-lg hover:border-dial-yellow hover:text-dial-yellow' href={`${principle.url}`} target='_blank' rel='noreferrer'>
