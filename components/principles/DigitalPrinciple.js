...
const DigitalPrinciple = ({ principle }) => {
  return (
    <a className='max-w-sm max-h-52 h-52 overflow-ellipsis overflow-hidden bg-white border-4 border-transparent p-4 m-4 shadow-lg hover:border-dial-yellow hover:text-dial-yellow' href={`${principle.url}`} target='_blank' rel='noreferrer'>
