...
const DigitalPrinciple = ({ principle }) => {
  return (
    <a href={`${principle.url}`} target='_blank' rel='noreferrer'>
      <div className='text-ellipsis overflow-hidden bg-white border-4 border-transparent shadow-lg hover:border-dial-yellow hover:text-dial-yellow p-4 m-4 max-w-sm max-h-52 h-52'>
