  ...
  return (
    <div className='bg-health-light-gray'>
      ...
      <div className='w-full flex flex-col md:flex-row gap-2'>
        <div className='md:w-1/2 pl-4 lg:pl-8 xl:pl-56 pr-12 py-12 text-health-blue text-lg flex flex-row gap-2'>
        ...
        <div className='md:w-1/2 pr-4 lg:pr-8 xl:pr-56 flex items-center'>
