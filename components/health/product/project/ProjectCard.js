...
const ProjectCard = (props) => {
  ...
  const [firstCountry] = project?.countries ?? []
        ...
        <div className='flex flex-col gap-y-4'>
          ...
          {firstCountry &&
            <div className="w-20 h-20 mx-auto">
              <img
                src={`https://flagsapi.com/${firstCountry.code.toUpperCase()}/flat/64.png`}
                alt={format('ui.country.logoAlt', { countryName: firstCountry.code })}
