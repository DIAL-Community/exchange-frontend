...
const EditHubCurriculumSubModule = ({ curriculumSlug, curriculumModuleSlug, curriculumSubModuleSlug }) => {
...
const CreateHubCurriculumSubModule = ({ curriculumSlug, curriculumModuleSlug }) => {
  const { formatMessage } = useIntl()
  const format = useCallback((id, values) => formatMessage({ id }, values), [formatMessage])
...
export { CreateHubCurriculumSubModule, EditHubCurriculumSubModule }
