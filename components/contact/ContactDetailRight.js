...
import DeleteContact from './fragments/DeleteContact'

const ContactDetailRight = forwardRef(({ contact, editingAllowed, deletingAllowed }, ref) => {
    ...
    <div className='px-4 lg:px-0 py-4 lg:py-6'>
      <div className='flex flex-col gap-y-3'>
        <div className='flex gap-x-3 ml-auto'>
          ...
          { deletingAllowed && <DeleteContact contact={contact} /> }
        </div>
