...
const CandidateStatusListRight = () => {
  ...
  return (
    <>
      <CandidateStatusSearchBar ref={topRef} />
      <ListStructure
      ...
      { data &&
        <Pagination
          ...
          totalCount={data.paginationAttributeCandidateStatus.totalCount}
          defaultPageSize={DEFAULT_PAGE_SIZE}
...
export default CandidateStatusListRight
