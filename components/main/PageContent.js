...
const PageContent = ({ activeTab, filter, mobileFilter, content, searchFilter, activeFilter }) => {
  return (
    <>
      { filter && <MobileFilter activeTab={activeTab} filter={mobileFilter ? mobileFilter : filter} /> }
