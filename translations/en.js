...
export const en = {
  ...
  'buildingBlock.no-product': 'We do not have any Product information for this Building Block.',
  'buildingBlock.disclaimer': 'Note: As part of the <a href="https://govstack.global">GovStack Initiative</a>, DIAL is working to map digital platforms with key Building Block functionalities. Currently, all mappings between products and building blocks are "Beta" and are shown as illustrative examples of how these tools may support building block functionalities. As Building Block specifications are developed, products that are aligned with the specifications will be tagged as such.',
  'buildingBlock.spec-link': 'The GovStack initiative has published a full specification for this building block. You can view the documentation at this link: ',
  ...
  'buildingBlock.no-workflow': 'We do not have any Workflow information for this Building Block.',
  ...
  'wizard.stepThree': 'Step 3: Building Blocks',
  'wizard.results': 'Results',
  'wizard.optional': '(Note: All fields are optional, but entering as much data as possible will allow for more accurate results)',
  ...
  'wizard.results.principlesDesc': 'The following Digital Principles are particularly important at each phase of your project. Click on the links below to learn more.',
  ...
  'wizard.bb.identificationandauthentication': 'Will the project require people to use an official/government identification?',
