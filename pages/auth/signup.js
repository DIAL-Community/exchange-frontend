...
const SignUp = () => {
  ...
  const [textFields, handleTextChange, resetTextFields] = textFieldDefinition({
    email: '',
    password: '',
  ...
  return (
    <>
      ...
      {
        created &&
          <div className='text-center bg-dial-gray-dark pt-8'>
            <div className='my-auto text-green-500'>{format('signUp.created')}</div>
            <div className='my-auto text-green-500'>{format('signUp.redirect')}</div>
          </div>
      }
      <div className='bg-dial-gray-dark pt-10' style={{ minHeight: '80vh' }}>
