...
import HubAdminMessageDetail from '../../../../../components/hub/admin/HubAdminMessageDetail'
...
const HubAdminBroadcastPage = ({ dpiTenants }) => {
      ...
      <ClientOnly clientTenants={dpiTenants}>
        ...
        { status === 'unauthenticated' || status === 'loading'
          ...
          : status === 'authenticated' && allowedToView(data.user)
            ? <HubAdminMessageDetail messageSlug={messageSlug} />
            : handleSessionError()
        }
        <HubFooter />
      </ClientOnly>
...
export default HubAdminBroadcastPage
