...
import HubAdminSetting from '../../../../components/hub/admin/HubAdminSettings'
...
const HubAdminSettingPage = ({ dpiTenants }) => {
  ...
  return (
    <>
      <NextSeo
        title={format('hub.admin.settings')}
...
export default HubAdminSettingPage
