...
const BBFullScreen = () => {
  ...
  const all_bb_desc = [
    { name: 'Analytics and Business Intelligence', status: 'future', slug: 'analytics_and_business_intel',
    ...
    { name: 'Digital Registries', status: 'published', url: 'https://govstack.gitbook.io/specification/building-blocks/digital-registries',
    ...
    { name: 'Identification and Authentication', status: 'published', url: 'https://govstack.gitbook.io/specification/building-blocks/identity-and-verification',
      desc: 'Enables unique identification and authentication of users, organizations and other entities.' },
    { name: 'Information Mediator', status: 'published', url: 'https://govstack.gitbook.io/specification/building-blocks/information-mediation',
    ...
    { name: 'Mobility Management', status: 'future',
      desc: 'Services to securely enable employees’ use and management of mobile devices and applications in a ' +
            'business context.' },
    { name: 'Payments', status: 'published', url: 'https://govstack.gitbook.io/specification/building-blocks/payments',
    ...
    { name: 'Registration', status: 'published', url: 'https://govstack.gitbook.io/specification/building-blocks/registration',
    ...
    { name: 'Security', status: 'published', url: 'https://govstack.gitbook.io/specification/building-blocks/security-requirements',
