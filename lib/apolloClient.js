...
export const EDITING_POLICY_QUERY = `${GRAPH_QUERY_CONTEXT_KEY}-Editing`
export const VIEWING_POLICY_QUERY = `${GRAPH_QUERY_CONTEXT_KEY}-Viewing`
export const CREATING_POLICY_QUERY = `${GRAPH_QUERY_CONTEXT_KEY}-Creating`
export const DELETING_POLICY_QUERY = `${GRAPH_QUERY_CONTEXT_KEY}-Deleting`
