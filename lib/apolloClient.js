        ...
        fields: {
          ...
          searchProducts: {
            keyArgs: [
              ...
              'buildingBlocks', 'productDeployable', 'isEndorsed', 'endorsers', 'search', 'sortColumn', 'sortDirection',
              'licenseTypes'
            ],
            merge
          },
          searchDatasets: {
            keyArgs: [
              'origins', 'sectors', 'countries', 'organizations', 'sdgs', 'tags', 'datasetTypes', 'search', 'sortColumn', 'sortDirection'
            ],
            merge
          },
